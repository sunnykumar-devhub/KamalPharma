  ...
  return (
    <footer className="relative bg-[#1A0B2E] text-white pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20 relative z-10 pt-10">
        {/* Column 1: Branding & Timings */}
        <div className="space-y-8">
          <Logo variant="footer" />
          <div>
            <h5 className="text-[10px] font-black uppercase tracking-widest text-[#7A3E9D] mb-4">Opening Hours</h5>
          ...
          <div className="flex items-center space-x-4">
            {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
              <a key={i} href="#" className="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-[#7A3E9D] hover:border-[#7A3E9D] transition-all duration-300">
                <Icon size={16} />
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="space-y-6">
            <a href="tel:+6236522452781" className="flex items-center space-x-4 group">
              ...
              <div>
                ...
                <p className="text-white text-sm font-bold">(62365) 2245 2781</p>
              </div>
            </a>
            <a href="https://wa.me/6236522452781" className="flex items-center space-x-4 group">
              ...
              <div>
                ...
                <p className="text-white text-sm font-bold">+62 365 2245 2781</p>
              </div>
            </a>
            <a href="mailto:contact@kamalphar.com" className="flex items-center space-x-4 group">
              <div className="w-10 h-10 bg-[#3B1E4D] rounded-xl flex items-center justify-center group-hover:scale-110 transition-all shadow-lg shadow-[#3B1E4D]/20">
                <Mail size={18} className="text-white" />
              </div>
              <div>
                <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Email Us</p>
                <p className="text-white text-sm font-bold">contact@kamalphar.com</p>
              </div>
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-[11px] font-bold">
            {quickLinks.map((link, i) => (
              <li key={i}>
                <Link to={link.path} className="hover:text-white transition-colors flex items-center space-x-2 group">
