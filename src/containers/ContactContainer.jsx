        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-8 mb-12">
            <div className="p-8 bg-white rounded-[2rem] shadow-xl border-b-4 border-[#7A3E9D] hover:-translate-y-2 transition-all">
              ...
              <p className="text-gray-500 font-bold text-sm">9570001222</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-[2rem] shadow-xl border-b-4 border-[#25D366] hover:-translate-y-2 transition-all">
              ...
              <p className="text-gray-500 font-bold text-sm">Chat with us</p>
            </div>
          </div>

          <div className="flex items-start space-x-6">
            <div className="w-12 h-12 bg-[#7A3E9D] rounded-xl flex items-center justify-center text-white shrink-0 shadow-lg">
              <MapPin size={24} />
            </div>
            <div>
              <h4 className="font-black text-[#3B1E4D] text-lg">Our Location</h4>
              <p className="text-gray-500 font-medium">Govind Mitra, Patna</p>
            </div>
          </div>
        </motion.div>
